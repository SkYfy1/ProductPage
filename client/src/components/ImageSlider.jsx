...
const ImageSlider = ({ prod }) => {
    ...
    return (
        <div className='flex flex-col w-[800px] gap-6 overflow-hidden'>
            ...
            <div className='w-fit flex gap-3 h-36 relative'>
                <svg onClick={() => setTranslate(prev => prev - 100)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-10 absolute top-1/2 text-white -translate-y-1/2 z-50 hover:cursor-help">
                ...
                <svg onClick={() => translate != 500 && setTranslate(prev => prev + 100)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-10 top-1/2 -translate-y-1/2 -right-10 text-white -translate-x-[100%] absolute hover:cursor-help">
